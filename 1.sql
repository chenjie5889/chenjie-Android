...
-- 2. 创建档案表（移除real_name字段，关联users表）
...
-- 用户1 - 硝苯地平（每日早上8:00）
(1, '硝苯地平', '08:00', '2026-03-11', 1, '2026-02-01 08:05:00'),
(1, '硝苯地平', '08:00', '2026-03-12', 1, '2026-02-01 08:05:00'),
(1, '硝苯地平', '08:00', '2026-03-13', 1, '2026-02-01 08:05:00'),
(1, '硝苯地平', '08:00', '2026-03-14', 1, '2026-02-01 08:05:00'),
(1, '硝苯地平', '08:00', '2026-03-15', 1, '2026-02-02 08:10:00'),
(1, '硝苯平地', '08:00', '2026-03-16', 0, '2026-02-03 08:15:00'),
(1, '硝苯地平', '08:00', '2026-03-17', 1, '2026-02-04 23:59:00'), 

-- 用户1 - 厄贝沙坦（每日晚上8:00）
(1, '厄贝沙坦', '20:00', '2026-03-11', 1, '2026-02-01 20:05:00'),
(1, '厄贝沙坦', '20:00', '2026-03-12', 1, '2026-02-01 20:05:00'),
(1, '厄贝沙坦', '20:00', '2026-03-13', 1, '2026-02-01 20:05:00'),
(1, '厄贝沙坦', '20:00', '2026-03-14', 1, '2026-02-01 20:05:00'),
(1, '厄贝沙坦', '20:00', '2026-03-15', 0, '2026-02-02 20:10:00'),
(1, '厄贝沙坦', '20:00', '2026-03-16', 0, '2026-02-03 23:30:00'), -- 漏服
(1, '厄贝沙坦', '20:00', '2026-03-17', 0, '2026-02-04 20:15:00'),

-- 用户1 - 二甲双胍（每日三次）
(1, '二甲双胍', '08:00', '2026-03-11', 1, '2026-02-04 08:20:00'),
(1, '二甲双胍', '12:00', '2026-03-11', 0, '2026-02-04 12:05:00'),
(1, '二甲双胍', '18:00', '2026-03-11', 0, '2026-02-04 18:15:00'),

(1, '二甲双胍', '08:00', '2026-03-12', 1, '2026-02-04 08:20:00'),
(1, '二甲双胍', '12:00', '2026-03-12', 0, '2026-02-04 12:05:00'),
(1, '二甲双胍', '18:00', '2026-03-12', 0, '2026-02-04 18:15:00'),

(1, '二甲双胍', '08:00', '2026-03-13', 1, '2026-02-04 08:20:00'),
(1, '二甲双胍', '12:00', '2026-03-13', 0, '2026-02-04 12:05:00'),
(1, '二甲双胍', '18:00', '2026-03-13', 0, '2026-02-04 18:15:00'),

(1, '二甲双胍', '08:00', '2026-03-14', 1, '2026-02-01 08:10:00'),
(1, '二甲双胍', '12:00', '2026-03-14', 1, '2026-02-01 12:15:00'),
(1, '二甲双胍', '18:00', '2026-03-14', 1, '2026-02-01 23:45:00'), -- 漏服

(1, '二甲双胍', '08:00', '2026-03-15', 1, '2026-02-02 08:05:00'),
(1, '二甲双胍', '12:00', '2026-03-15', 1, '2026-02-02 12:10:00'),
(1, '二甲双胍', '18:00', '2026-03-15', 1, '2026-02-02 18:20:00'),

(1, '二甲双胍', '08:00', '2026-03-16', 1, '2026-02-03 08:15:00'),
(1, '二甲双胍', '12:00', '2026-03-16', 1, '2026-02-03 15:30:00'), -- 漏服
(1, '二甲双胍', '18:00', '2026-03-16', 1, '2026-02-03 18:10:00'),

(1, '二甲双胍', '08:00', '2026-03-17', 1, '2026-02-04 08:20:00'),
(1, '二甲双胍', '12:00', '2026-03-17', 0, '2026-02-04 12:05:00'),
(1, '二甲双胍', '18:00', '2026-03-17', 0, '2026-02-04 18:15:00');
...
-- 插入示例数据
INSERT INTO `custom_metrics` (user_id, metric_name, unit) VALUES
(1, '收缩压', 'mmHg'),
(1, '血糖', 'mmol/L'),
(1, '体重', 'kg'),
(2, '血压', 'mmHg'),
...
INSERT INTO `custom_metric_records` (metric_id, user_id, record_value, record_date, note) VALUES
-- 用户1的血压记录
(1, 1, '118', '2026-03-11', '早晨起床'),
(1, 1, '122', '2026-03-12', '早晨起床'),
(1, 1, '125', '2026-03-13', '早晨起床'),
(1, 1, '119', '2026-03-14', '早晨起床'),
(1, 1, '121', '2026-03-15', '早晨起床'),
(1, 1, '124', '2026-03-16', '早晨起床'),
(1, 1, '120', '2026-03-17', '早晨起床'),
-- 用户1的血糖记录
(2, 1, '5.2', '2026-03-13', '空腹'),
(2, 1, '7.8', '2026-03-13', '餐后2小时'),
(2, 1, '5.1', '2026-03-14', '空腹'),
(2, 1, '5.3', '2026-03-15', '空腹'),
(2, 1, '5.0', '2026-03-16', '空腹'),
(2, 1, '5.4', '2026-03-17', '空腹'),
-- 用户1的体重记录
(3, 1, '70.5', '2026-02-17', '早晨空腹'),
(3, 1, '70.2', '2026-02-20', '早晨空腹'),
(3, 1, '70.0', '2026-02-23', '早晨空腹');